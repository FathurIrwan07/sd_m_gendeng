        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid lg:grid-cols-2 gap-12">
                    ...
                    <div class="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                        ...
                        <ul class="space-y-4">
                            ...
                            <li class="flex items-start gap-3">
                                <svg class="w-5 h-5 text-[#B91C1C] flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mt-6">
                            <img src="{{ Storage::url($infoPpdb->gambar_brosur) }}" 
                                 alt="Brosur PPDB" 
                ...
                <div data-aos="fade-left">
                    <div class="bg-gradient-to-br from-[#B91C1C] to-[#991B1B] rounded-2xl p-8 shadow-xl text-white sticky top-24">
                        ...
                        <a href="{{ $infoPpdb->link_pendaftaran }}" 
                           target="_blank"
                        ...
                        @else
                        <button class="w-full px-8 py-4 bg-white text-[#B91C1C] rounded-lg hover:bg-gray-50 transition-colors shadow-lg font-semibold">
                            Segera Dibuka
                        </button>
                        @endif
            ...
            <div class="mt-16 bg-white rounded-2xl p-8 shadow-lg border border-gray-100 text-center" data-aos="fade-up">
                ...
                <a href="{{ route('about') }}#kontak" class="inline-flex items-center px-8 py-3 border-2 border-[#B91C1C] text-[#B91C1C] rounded-lg hover:bg-[#B91C1C] hover:text-white transition-all duration-300">
                    Hubungi Kami
    ...
    <section class="py-20 bg-gradient-to-b from-white to-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="bg-white rounded-2xl p-12 shadow-lg border border-gray-100">
                ...
                <a href="{{ route('about') }}#kontak" class="inline-flex items-center px-8 py-3 bg-[#B91C1C] text-white rounded-lg hover:bg-[#991B1B] transition-all duration-300">
                    Hubungi Kami
                </a>
            </div>
        </div>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-gradient-to-br from-gray-50 to-white p-6 rounded-2xl border border-gray-100 text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1" data-aos="zoom-in" data-aos-delay="{{ $index * 100 }}">
