...
{{-- Hero Section - Improved --}}
{{-- Hero Section - Improved --}}
<section class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-white via-red-50/30 to-white">
        ...
        <div class="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
            ...
            <div class="relative lg:pl-8" data-aos="fade-left">
                ...
                <div class="relative rounded-3xl overflow-hidden shadow-2xl">
                    <img src="{{ asset('template/img/sekolah.jpg') }}"
                        alt="Gambar Bangunan Sekolah"
                    ...
                    <div class="bg-white rounded-2xl shadow-2xl p-6 lg:p-8">
                        <div class="grid grid-cols-3 gap-4 lg:gap-6">
                            ...
                            <div class="text-center">
                                <div class="text-[#B91C1C] font-bold text-2xl lg:text-3xl mb-1">{{ $totalPrestasi }}+</div>
                                <div class="text-sm lg:text-base text-gray-600">Prestasi</div>
                            </div>

                            <div class="text-center border-x border-gray-200">
                                <div class="text-[#B91C1C] font-bold text-2xl lg:text-3xl mb-1">{{ $totalGuru }}+</div>
                ...
                <div class="group bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300" data-aos="fade-up" data-aos-delay="{{ $index * 100 }}">
                    <div class="relative h-48 overflow-hidden">
                        @if($program->foto_program)
                            <img src="{{ Storage::url($program->foto_program) }}" 
    ...
    <section class="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 text-center" data-aos="fade-up" data-aos-delay="{{ $index * 100 }}">
                    <div class="w-16 h-16 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-xl flex items-center justify-center mx-auto mb-4">
            ...
            <div class="text-center" data-aos="fade-up">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    @if($infoPpdb && $infoPpdb->gambar_brosur)
                        <a href="{{ Storage::url($infoPpdb->gambar_brosur) }}" 
                           download 
