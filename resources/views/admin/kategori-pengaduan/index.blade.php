...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <a href="{{ route('kategori-pengaduan.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
            ...
            <table class="table table-bordered table-hover" width="100%" cellspacing="0">
                <thead class="bg-light">
                    <tr>
                        ...
                        <th width="15%" class="text-center">Jumlah Pengaduan</th>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="alert alert-warning mt-3 mb-0">
                                        ...
                                        Kategori ini memiliki <strong>{{ $item->pengaduan_count }} pengaduan</strong> dan tidak dapat dihapus!
                                    </div>
                                    @endif
                                </div>
